...
desenhaGrafico(quant,graf_tempoRandomica,graf_tempoInvertida,"Tamanho", "Tempo", "saida_time")
desenhaGrafico(quant,graf_operacoesRandomica,graf_operacoesInvertida, "Tamanho", "Operacoes", "saida_operacoes")
